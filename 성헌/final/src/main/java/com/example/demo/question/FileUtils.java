...
public class FileUtils {
	...
	private final String uploadPath = Paths.get("D:", "kdigital12307", "springboot","file-upload").toString();
     ...
     */
    public List
    <FileRequest> uploadFiles(final List<MultipartFile> multipartFiles) {
     ...
     */
    public void deleteFiles(final List<FileRequest> files) {
